...
namespace NorthwindExercise.DAL
{
    public class NorthwindInitializer : CreateDatabaseIfNotExists<NorthwindContext>
    {
        protected override void Seed(NorthwindContext context)
        {
            ...
            {
                new Employee { LastName = "Davolio", FirstName = "Nancy", Title = "Sales Representative", TitleOfCourtesy = "Ms.", BirthDate = Convert.ToDateTime("08/12/1948"), HireDate = Convert.ToDateTime("01/05/1992"), Address = "507 / 20th Ave. E.Apt. 2A", City = "Seattle" },
                new Employee { LastName = "Fuller", FirstName = "Andrew", Title = "Vice President, Sales", TitleOfCourtesy = "Dr.", BirthDate = Convert.ToDateTime("19/02/1952"), HireDate = Convert.ToDateTime("14/08/1992"), Address = "908 W. Capital Way", City = "Tacoma" },
                new Employee { LastName = "Leverling", FirstName = "Janet", Title = "Sales Representative", TitleOfCourtesy = "Ms.", BirthDate = Convert.ToDateTime("30/08/1963"), HireDate = Convert.ToDateTime("01/04/1992"), Address = "722 Moss Bay Blvd.", City = "Kirkland" },
                new Employee { LastName = "Peacock", FirstName = "Margaret", Title = "Sales Representative", TitleOfCourtesy = "Mrs.", BirthDate = Convert.ToDateTime("19/09/1937"), HireDate = Convert.ToDateTime("03/05/1993"), Address = "4110 Old Redmond Rd.", City = "Redmond" },
                new Employee { LastName = "Buchanan", FirstName = "Steven", Title = "Sales Manager", TitleOfCourtesy = "Mr.", BirthDate = Convert.ToDateTime("04/03/1955"), HireDate = Convert.ToDateTime("17/10/1993"), Address = "14 Garrett Hill", City = "London" },
                new Employee { LastName = "Suyama", FirstName = "Michael", Title = "Sales Representative", TitleOfCourtesy = "Mr.", BirthDate = Convert.ToDateTime("02/07/1963"), HireDate = Convert.ToDateTime("17/10/1993"), Address = "Coventry House Miner Rd.", City = "London" },
                new Employee { LastName = "King", FirstName = "Robert", Title = "Sales Representative", TitleOfCourtesy = "Mr.", BirthDate = Convert.ToDateTime("29/05/1960"), HireDate = Convert.ToDateTime("02/01/1994"), Address = "Edgeham Hollow Winchester Way", City = "London" },
                new Employee { LastName = "Callahan", FirstName = "Laura", Title = "Inside Sales Coordinator", TitleOfCourtesy = "Ms.", BirthDate = Convert.ToDateTime("09/01/1958"), HireDate = Convert.ToDateTime("05/03/1994"), Address = "4726 / 11th Ave. N.E.", City = "Seattle" },
                new Employee { LastName = "Dodsworth", FirstName = "Anne", Title = "Sales Representative", TitleOfCourtesy = "Ms.", BirthDate = Convert.ToDateTime("27/01/1966"), HireDate = Convert.ToDateTime("15/11/1994"), Address = "7 Houndstooth Rd.", City = "London" }
            };
            ...
            {
                new Order { CustomerID = "ALFKI", EmployeeID = 5, OrderDate = Convert.ToDateTime("04/07/1996"), RequiredDate = Convert.ToDateTime("01/08/1996"), ShippedDate = Convert.ToDateTime("16/07/1996"), ShipVia = 3, Freight = Convert.ToDecimal(32.3800), ShipName = "Vins et alcools Chevalier", ShipAddress = "59 rue de l'Abbaye", ShipCity = "Reims", ShipPostalCode = "51100", ShipCountry = "France" },
                new Order { CustomerID = "ANATR", EmployeeID = 6, OrderDate = Convert.ToDateTime("05/07/1996"), RequiredDate = Convert.ToDateTime("16/08/1996"), ShippedDate = Convert.ToDateTime("10/07/1996"), ShipVia = 1, Freight = Convert.ToDecimal(11.6100), ShipName = "Toms Spezialitäten", ShipAddress = "Luisenstr. 48", ShipCity = "Münster", ShipPostalCode = "44087", ShipCountry = "Germany" },
                new Order { CustomerID = "ANTON", EmployeeID = 4, OrderDate = Convert.ToDateTime("08/07/1996"), RequiredDate = Convert.ToDateTime("05/08/1996"), ShippedDate = Convert.ToDateTime("12/07/1996"), ShipVia = 2, Freight = Convert.ToDecimal(65.8300), ShipName = "Hanari Carnes", ShipAddress = "Rua do Paço, 67", ShipCity = "Rio de Janeiro", ShipRegion = "RJ", ShipPostalCode = "05454-876", ShipCountry = "Brazil" }
            };
